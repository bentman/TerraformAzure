...
locals {
  ...
  powershell_dcpromo = "${local.log_path}; ${local.prov_log}; ${local.psrepo_1}; ${local.add_feat}; ${local.add_rsat}; ${local.add_modu}; ${local.dns_feat}; ${local.dns_rsat}; ${local.dns_modu}; ${local.ad_promo}; ${local.ssh_open}; ${local.posh_ssh}; ${local.nla_disa}; ${local.fw_disab}; ${local.arc_disa}; ${local.stop_log}; ${local.restart6}; ${local.exit_hck}"

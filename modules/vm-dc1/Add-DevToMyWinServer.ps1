...
Invoke-WebRequest -Uri $licXml_Link -OutFile $LicXml_Name -UseBasicParsing -Verbose
...
Invoke-WebRequest -Uri $winGet_Link -OutFile $winGet_Name -UseBasicParsing -Verbose
